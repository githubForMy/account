...
public enum AccountErrorEnum {
    ...
    GET_CANCEL_APPLY_INFO_FAILURE(true, "1031", "获取注销申请相关信息失败", ""),
    APPLY_ACCOUNT_CANCEL_FAILURE(true, "1032", "申请账户注销失败", ""),
    CANCEL_ACCOUNT_CANCEL_APPLY_FAILURE(true, "1033", "取消账户申请注销失败", ""),
    ALREADY_APPLY(true, "1034", "24小时内已提交注销申请，请稍候重试", ""),
    CANCEL_ACCOUNT_AUDITING(true, "1035", "注销申请已在审核中，请耐心等待", ""),
    RENEW_VISITOR_ACCOUNT_FAILURE(true, "1036", "恢复游客账户失败", ""),
    GET_ACCOUNT_SCORE_FAILURE(true, "1037", "获取用户积分信息失败", ""),

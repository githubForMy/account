...
public class AccountMainServiceImpl implements AccountMainService {
    ...
    public void saveMainAccount(SaveMainAccountRequest request) {
        ...
        int saveNum = accountMainMapper.saveAccountMain(accountMainEntity);
        if (saveNum != 1) {
    ...
    public void updateMainAccount(MainAccountRequest request) {
        ...
        accountMainEntityQuery.setMainAccountId(request.getMainAccountId());
        ...
        accountMainEntityUpdate.setMainAccountId(request.getMainAccountId());
        accountMainEntityUpdate.setUpdateTime(new Date());
        int updateNum = accountMainMapper.updateAccountMain(accountMainEntityUpdate);
        if (updateNum != 1) {
    ...
    public MainAccountVO getMainAccountInfo(MainAccountRequest request) {
        ...
        mainAccountVO.setMainAccountId(accountMainEntity.getMainAccountId());
